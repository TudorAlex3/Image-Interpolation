...
function R = bilinear_resize(I, p, q)
    ...
    Transformare_inversa=[1./s_x 0;0 1./s_y];
    ...
    for y = 0 : p - 1
        for x = 0 : q - 1
            ...
            vector = Transformare_inversa*[x,y]';
            x_p = vector(1);
            y_p = vector(2);
            ...
            % TODO: calculeaza coeficientii de interplare
            coef = bilinear_coef(I, x1, y1, x2, y2);
            
            % TODO: calculeaza valoarea interpolata a pixelului (x, y)
            % Obs: pentru scrierea in imagine, x si y sunt in coordonate de
            % la 0 la n - 1 si trebuie aduse in coordonate de la 1 la n
            R(y+1, x+1) = coef(1)+x_p*coef(2)+y_p*coef(3)+x_p*y_p*coef(4);
